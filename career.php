        ...
        <div class="row">
            ...
            ?>
                <div class="content col-3">
                    ...
                    <p class="butt"><a href="job_apply.php?id=<?php echo $row['id']; ?>&&email=<?php echo $_REQUEST['email']; ?>"><button class="btn btn-primary" type="submit" name="" id="">Apply Now</button></a></p>
                </div>
            <?php } ?>
        </div>
    </div>
